...
export const GEN_META = [
  ...
  { id: 'stage2', label: '🌱 Stage-2 Cash Leaders', color: '#16A34A', desc: 'ScreeningMantis-style: CASH equities entering a fresh Stage-2 uptrend (breakout from a base), ranked by RELATIVE STRENGTH, near 52-week highs, with money flowing in (Chaikin) — catches leaders BEFORE the big move. Full screener at /screener.html. Feeds the Cash sleeve. Educational, not advice.' },
